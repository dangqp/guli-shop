        ...
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
                  <a title="全部" href="#" @click="initCourseFirst(1)" :class="{active:index==1}">全部</a>
                </li>
  ...
  export default {
    ...
    methods: {
      ...
      searchOne(subjectParentId, index) {
        ...
        this.twoIndex = -1
        this.index = -1
        this.searchObj.subjectId = "" //查询一级分类，二级分类赋值为空
        this.subSubjectList = [] //每次查询清空上一次的

        //把一级分类点击id值，赋值给searchObj
        this.searchObj.subjectParentId = subjectParentId
        //点击某个一级分类进行条件查询 默认查第一页
        this.gotoPage(1)
