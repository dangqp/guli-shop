  ...
  export default {
    ...
    methods: {
       ...
       submitRegister() {
         registerApi.registerMember(this.params)
          .then(response => {
            ...
            //跳转登录页面
            this.$router.push({path:'/login',query:{mobile: this.params.mobile,passwod:this.params.password}})
            //this.$router.push({name:'/login',params:{mobile: this.params.mobile,passwod:this.params.password}})
       ...
       getCodeFun() {
         ...
         if (utils.checkPhone(this.params.mobile)){
