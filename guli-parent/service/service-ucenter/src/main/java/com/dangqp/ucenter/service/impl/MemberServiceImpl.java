package com.dangqp.ucenter.service.impl;
...
import com.dangqp.ucenter.mapper.MemberMapper;
import com.dangqp.ucenter.service.MemberService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.dangqp.ucenter.utils.MD5;
...
public class MemberServiceImpl extends ServiceImpl<MemberMapper, Member> implements MemberService {
    ...
    public String login(Member member) {
        ...
        if(mobileMember == null) {//没有这个手机号
            throw new GuliException(20001,"用户信息不存在");
        }
