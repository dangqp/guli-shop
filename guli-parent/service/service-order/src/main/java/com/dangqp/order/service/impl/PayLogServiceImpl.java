...
import com.dangqp.order.entity.PayLog;
import com.dangqp.order.mapper.PayLogMapper;
import com.dangqp.order.service.OrderService;
import com.dangqp.order.service.PayLogService;
import com.dangqp.order.utils.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNatvie(String orderNo) {
        try {
            ...
            m.put("sign", WXPayUtil.generateNonceStr());
            ...
            if(!StringUtils.endsWithIgnoreCase("SUCCESS",resultMap.get("return_code"))){
